...
modelling_data <- modelling_data %>%
  mutate(
    Group = case_when(
      ...
      Pollinator_family == "Bombyliidae" ~ "Bombyliidae",
      TRUE ~ Group
    )
  )
...
#### Save data ####
saveRDS(fit_SES_pdi, "Data/fit_SES_pdi_groups.rds")
saveRDS(fit_SES_nd, "Data/fit_SES_nd_groups.rds")
saveRDS(fit_SES_mh, "Data/fit_SES_mh_groups.rds")
