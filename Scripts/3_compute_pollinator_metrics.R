############################################################ #
# Script name: "3_compute_metrics.R"
# Objective: Compute metrics per-pollinator network 
#             for observed and null networks
# Inputs:
#   - Data/long_format_nulls.rds              (observed + null networks in long format)
...
#### Load data ####
net_long_no0 = readRDS("Data/long_format_nulls.rds")
...
###################### loop all the metrics with data.table
setDT(net_long_no0)
